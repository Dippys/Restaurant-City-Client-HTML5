 ...
 *
 *   extract-symbols -> build-atlases  (per atlas SWF)
 *   build-audio -> build-data -> build-manifest -> verify-pipeline
 *
 *   node tools/pipeline.mjs [swfName ...]   (default: all atlas SWFs)
 */
